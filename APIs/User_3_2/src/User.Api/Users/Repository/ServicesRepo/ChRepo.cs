...
public class ChRepo : IChRepo
{
    ...
    public ChRepo()
    {
        ...
        FilePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Data", "Channels.json");
    ...
    public List<UserChannel>? GetAllChannels()
    {
        ...
        {
            return new List<UserChannel>();
        }

        var channels = JsonSerializer.Deserialize<List<UserChannel>>(json);
        return channels;
    }
